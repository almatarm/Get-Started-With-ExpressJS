import {Category, CategoryServiceFactory, CategoryConfiguration,
...
// one category without parent (root) and a child category.
// export const catService = new Category("service");
// export const catProd = new Category("product", catService);
export const log = new Category('logos');

// Optionally get a logger for a category, since 0.5.0 this is not necessary anymore,
// you can use the category itself to log.
